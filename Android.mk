...
LOCAL_SRC_FILES += $(call all-java-files-under, ../PACPerformance/src)
LOCAL_RESOURCE_DIR := packages/apps/PACPerformance/res
...
LOCAL_AAPT_FLAGS += --extra-packages com.koushikdutta.superuser:com.koushikdutta.widgets --auto-add-overlay --extra-packages com.pac.performance
