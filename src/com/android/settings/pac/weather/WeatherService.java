...
package com.android.settings.pac.weather;
...
public class WeatherService extends IntentService {
    ...
    public static final String INTENT_WEATHER_REQUEST = "com.pac.INTENT_WEATHER_REQUEST";
    public static final String INTENT_WEATHER_UPDATE = "com.pac.INTENT_WEATHER_UPDATE";
    public static final String INTENT_EXTRA_ISMANUAL = "com.pac.INTENT_EXTRA_ISMANUAL";
    public static final String INTENT_EXTRA_TYPE = "com.pac.INTENT_EXTRA_TYPE";
    public static final String INTENT_EXTRA_NEWLOCATION = "com.pac.INTENT_EXTRA_NEWLOCATION";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (Settings.PAC.getInt(getContentResolver(), Settings.PAC.USE_WEATHER, 0) == 0) {
            stopSelf();
            return;
        }
