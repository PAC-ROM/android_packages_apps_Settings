...
public class StatusBarClockStyle extends SettingsPreferenceFragment
    ...
    private PreferenceScreen createCustomView() {
        ...
        mClockStyle.setValue(Integer.toString(Settings.PAC.getInt(getActivity()
                .getContentResolver(), Settings.PAC.STATUSBAR_CLOCK_STYLE,
                0)));
        ...
        mClockAmPmStyle.setValue(Integer.toString(Settings.PAC.getInt(getActivity()
                .getContentResolver(), Settings.PAC.STATUSBAR_CLOCK_AM_PM_STYLE,
                0)));
        ...
        int intColor = Settings.PAC.getInt(getActivity().getContentResolver(),
                    Settings.PAC.STATUSBAR_CLOCK_COLOR, -2);
        if (intColor == -2) {
        ...
        mClockDateDisplay.setValue(Integer.toString(Settings.PAC.getInt(getActivity()
                .getContentResolver(), Settings.PAC.STATUSBAR_CLOCK_DATE_DISPLAY,
                0)));
        mClockDateDisplay.setSummary(mClockDateDisplay.getEntry());

        mClockDateStyle = (ListPreference) findPreference(PREF_CLOCK_DATE_STYLE);
        mClockDateStyle.setOnPreferenceChangeListener(this);
        mClockDateStyle.setValue(Integer.toString(Settings.PAC.getInt(getActivity()
                .getContentResolver(), Settings.PAC.STATUSBAR_CLOCK_DATE_STYLE,
                0)));
        ...
        mStatusBarClock.setChecked((Settings.PAC.getInt(
                getActivity().getApplicationContext().getContentResolver(),
                Settings.PAC.STATUS_BAR_CLOCK, 1) == 1));
        mStatusBarClock.setOnPreferenceChangeListener(this);

        boolean mClockDateToggle = Settings.PAC.getInt(getActivity().getContentResolver(),
                    Settings.PAC.STATUSBAR_CLOCK_DATE_DISPLAY, 0) != 0;
        if (!mClockDateToggle) {
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mClockAmPmStyle) {
            ...
            Settings.PAC.putInt(getActivity().getContentResolver(),
                    Settings.PAC.STATUSBAR_CLOCK_AM_PM_STYLE, val);
            ...
            Settings.PAC.putInt(getActivity().getContentResolver(),
                    Settings.PAC.STATUSBAR_CLOCK_STYLE, val);
            ...
            Settings.PAC.putInt(getActivity().getContentResolver(),
                    Settings.PAC.STATUSBAR_CLOCK_COLOR, intHex);
            return true;
        } else if (preference == mClockDateDisplay) {
            int val = Integer.parseInt((String) newValue);
            int index = mClockDateDisplay.findIndexOfValue((String) newValue);
            Settings.PAC.putInt(getActivity().getContentResolver(),
                    Settings.PAC.STATUSBAR_CLOCK_DATE_DISPLAY, val);
            ...
            if (index == CUSTOM_CLOCK_DATE_FORMAT_INDEX) {
                ...
                String oldText = Settings.PAC.getString(
                    getActivity().getContentResolver(),
                    Settings.PAC.STATUSBAR_CLOCK_DATE_FORMAT);
                if (oldText != null) {
                ...
                alert.setPositiveButton(R.string.menu_save, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialogInterface, int whichButton) {
                        ...
                        Settings.PAC.putString(getActivity().getContentResolver(),
                            Settings.PAC.STATUSBAR_CLOCK_DATE_FORMAT, value);
                ...
                if ((String) newValue != null) {
                    Settings.PAC.putString(getActivity().getContentResolver(),
                        Settings.PAC.STATUSBAR_CLOCK_DATE_FORMAT, (String) newValue);
                }
            }
            return true;
        }
    ...
    private void parseClockDateFormats() {
        ...
        int dateFormat = Settings.PAC.getInt(getActivity()
                .getContentResolver(), Settings.PAC.STATUSBAR_CLOCK_DATE_STYLE, 0);
