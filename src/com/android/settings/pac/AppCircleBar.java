...
public class AppCircleBar extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTriggerWidthPref.setValue(Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.APP_CIRCLE_BAR_TRIGGER_WIDTH, 10));
        ...
        mTriggerTopPref.setValue(Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.APP_CIRCLE_BAR_TRIGGER_TOP, 0));
        ...
        mTriggerBottomPref.setValue(Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.APP_CIRCLE_BAR_TRIGGER_HEIGHT, 100));
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (preference == mIncludedAppCircleBar) {
            ...
            Settings.PAC.putInt(getContentResolver(),
                    Settings.PAC.APP_CIRCLE_BAR_TRIGGER_WIDTH, width);
            return true;
        } else if (preference == mTriggerTopPref) {
            int top = ((Integer)objValue).intValue();
            Settings.PAC.putInt(getContentResolver(),
                    Settings.PAC.APP_CIRCLE_BAR_TRIGGER_TOP, top);
            return true;
        } else if (preference == mTriggerBottomPref) {
            int bottom = ((Integer)objValue).intValue();
            Settings.PAC.putInt(getContentResolver(),
                    Settings.PAC.APP_CIRCLE_BAR_TRIGGER_HEIGHT, bottom);
            return true;
        }
    ...
    private Set<String> getIncludedApps() {
        String included = Settings.PAC.getString(getActivity().getContentResolver(),
                Settings.PAC.WHITELIST_APP_CIRCLE_BAR);
    ...
    private void storeIncludedApps(Set<String> values) {
        ...
        Settings.PAC.putString(getActivity().getContentResolver(),
                Settings.PAC.WHITELIST_APP_CIRCLE_BAR, builder.toString());
    }
    ...
    public void onPause() {
        super.onPause();
        Settings.PAC.putInt(getContentResolver(),
                Settings.PAC.APP_CIRCLE_BAR_SHOW_TRIGGER, 0);
    }
    ...
    public void onResume() {
        super.onResume();
        Settings.PAC.putInt(getContentResolver(),
                Settings.PAC.APP_CIRCLE_BAR_SHOW_TRIGGER, 1);
    }
}
