...
public class ActiveDisplaySettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEnabledPref.setChecked((Settings.PAC.getInt(mResolver,
                Settings.PAC.ENABLE_ACTIVE_DISPLAY, 0) == 1));
        mEnabledPref.setOnPreferenceChangeListener(this);

        mShowTextPref = (CheckBoxPreference) prefSet.findPreference(KEY_SHOW_TEXT);
        mShowTextPref.setChecked((Settings.PAC.getInt(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_TEXT, 0) == 1));

        mShowContentPref = (CheckBoxPreference) prefSet.findPreference(KEY_SHOW_CONTENT);
        mShowContentPref.setChecked((Settings.PAC.getInt(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_CONTENT, 1) != 0));
        ...
        if (!DeviceUtils.deviceSupportsProximitySensor(mContext)) {
            ...
            mBypassPref.setChecked((Settings.PAC.getInt(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_BYPASS, 1) != 0));

            int mode = Settings.PAC.getInt(mResolver,
                    Settings.PAC.ACTIVE_DISPLAY_POCKET_MODE, 0);
            ...
            long threshold = Settings.PAC.getLong(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_THRESHOLD, 5000L);
            ...
            mTurnOffModePref.setChecked((Settings.PAC.getInt(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_TURNOFF_MODE, 0) == 1));
        }

        mAllNotificationsPref = (CheckBoxPreference) prefSet.findPreference(KEY_ALL_NOTIFICATIONS);
        mAllNotificationsPref.setChecked((Settings.PAC.getInt(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_ALL_NOTIFICATIONS, 0) == 1));

        mHideLowPriorityPref = (CheckBoxPreference) prefSet.findPreference(KEY_HIDE_LOW_PRIORITY);
        mHideLowPriorityPref.setChecked((Settings.PAC.getInt(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_HIDE_LOW_PRIORITY_NOTIFICATIONS, 0) == 1));
        ...
        if (!DeviceUtils.deviceSupportsLightSensor(mContext)) {
            ...
            mSunlightModePref.setChecked((Settings.PAC.getInt(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_SUNLIGHT_MODE, 0) == 1));
        }

        mRedisplayPref = (ListPreference) prefSet.findPreference(KEY_REDISPLAY);
        long timeout = Settings.PAC.getLong(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_REDISPLAY, 0);
        ...
        mShowDatePref.setChecked((Settings.PAC.getInt(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_SHOW_DATE, 0) == 1));
        ...
        mBrightnessLevel.setValue(Settings.PAC.getInt(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_BRIGHTNESS, maximumBacklight) - minimumBacklight);
        ...
        timeout = Settings.PAC.getLong(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_TIMEOUT, 8000L);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mRedisplayPref) {
            ...
            Settings.PAC.putInt(mResolver,
                    Settings.PAC.ENABLE_ACTIVE_DISPLAY,
            ...
            Settings.PAC.putInt(mResolver,
                    Settings.PAC.ACTIVE_DISPLAY_BRIGHTNESS, brightness);
            return true;
    ...
    private void updatePocketModeSummary(int value) {
        ...
        Settings.PAC.putInt(mResolver,
            Settings.PAC.ACTIVE_DISPLAY_POCKET_MODE, value);
    }
    ...
    private void updateRedisplaySummary(long value) {
        ...
        Settings.PAC.putLong(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_REDISPLAY, value);
    }
    ...
    private void updateTimeoutSummary(long value) {
        try {
            ...
            Settings.PAC.putLong(mResolver,
                    Settings.PAC.ACTIVE_DISPLAY_TIMEOUT, value);
    ...
    private void updateThresholdSummary(long value) {
        try {
            ...
            Settings.PAC.putLong(mResolver,
                    Settings.PAC.ACTIVE_DISPLAY_THRESHOLD, value);
        } catch (ArrayIndexOutOfBoundsException e) {
        }
    }

    private Set<String> getExcludedApps() {
        String excluded = Settings.PAC.getString(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_EXCLUDED_APPS);
    ...
    private void storeExcludedApps(Set<String> values) {
        ...
        Settings.PAC.putString(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_EXCLUDED_APPS, builder.toString());
    }

    private Set<String> getPrivacyApps() {
        String privacies = Settings.PAC.getString(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_PRIVACY_APPS);
    ...
    private void storePrivacyApps(Set<String> values) {
        ...
        Settings.PAC.putString(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_PRIVACY_APPS, builder.toString());
    }
