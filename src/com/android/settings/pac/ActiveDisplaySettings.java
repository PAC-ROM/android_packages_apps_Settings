    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mRedisplayPref) {
            ...
            Settings.PAC.putInt(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_REDISPLAY, val);
            ...
            Settings.PAC.putInt(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_POCKET_MODE, val);
            ...
            Settings.PAC.putInt(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_TIMEOUT, val);
            ...
            Settings.PAC.putInt(mResolver,
                Settings.PAC.ACTIVE_DISPLAY_THRESHOLD, val);
