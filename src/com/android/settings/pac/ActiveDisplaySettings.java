...
public class ActiveDisplaySettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHideLowPriorityPref.setChecked((Settings.PAC.getInt(getContentResolver(),
        ...
        mPocketModePref = (ListPreference) findPreference(KEY_POCKET_MODE);
            ...
            int mode = Settings.PAC.getInt(getContentResolver(),
        ...
        mSunlightModePref.setChecked((Settings.PAC.getInt(getContentResolver(),
        ...
        long timeout = Settings.PAC.getLong(getContentResolver(),
        ...
        mShowDatePref.setChecked((Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.ACTIVE_DISPLAY_SHOW_DATE, 0) == 1));

        mShowAmPmPref = (CheckBoxPreference) findPreference(KEY_SHOW_AMPM);
        mShowAmPmPref.setChecked((Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.ACTIVE_DISPLAY_SHOW_AMPM, 0) == 1));

        mBrightnessLevel = (SeekBarPreference) findPreference(KEY_BRIGHTNESS);
        mBrightnessLevel.setValue(Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.ACTIVE_DISPLAY_BRIGHTNESS, 100));
        ...
        timeout = Settings.PAC.getLong(getContentResolver(),
        ...
        long threshold = Settings.PAC.getLong(getContentResolver(),
        ...
        mTurnOffModePref.setChecked((Settings.PAC.getInt(getContentResolver(),
    ...
    private void updateRedisplaySummary(long value) {
        ...
        Settings.PAC.putLong(getContentResolver(),
