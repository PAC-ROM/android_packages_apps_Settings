...
public class WakeLockBlocker extends SettingsPreferenceFragment {
    ...
    private boolean isFirstEnable() {
        return Settings.PAC.getString(getActivity().getContentResolver(),
                Settings.PAC.WAKELOCK_BLOCKING_ENABLED) == null;
    }

    private void updateSwitches() {
        mBlockerEnabled.setChecked(Settings.PAC.getInt(getActivity().getContentResolver(),
    ...
    private void updateBlockedWakeLocksList() {
        String blockedWakelockList = Settings.PAC.getString(getActivity().getContentResolver(),
