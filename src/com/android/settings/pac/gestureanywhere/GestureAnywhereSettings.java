...
package com.android.settings.pac.gestureanywhere;
...
public class GestureAnywhereSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEnabledPref.setChecked((Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.GESTURE_ANYWHERE_ENABLED, 0) == 1));
        ...
        int position = Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.GESTURE_ANYWHERE_POSITION, Gravity.LEFT);
        ...
        mTriggerTopPref.setValue(Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.GESTURE_ANYWHERE_TRIGGER_TOP, 0));
        ...
        mTriggerBottomPref.setValue(Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.GESTURE_ANYWHERE_TRIGGER_HEIGHT, 100));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mPositionPref) {
            ...
            Settings.PAC.putInt(getContentResolver(),
                    Settings.PAC.GESTURE_ANYWHERE_TRIGGER_WIDTH, width);
            return true;
        } else if (preference == mTriggerTopPref) {
            int top = ((Integer)newValue).intValue();
            Settings.PAC.putInt(getContentResolver(),
                    Settings.PAC.GESTURE_ANYWHERE_TRIGGER_TOP, top);
            return true;
        } else if (preference == mTriggerBottomPref) {
            int bottom = ((Integer)newValue).intValue();
            Settings.PAC.putInt(getContentResolver(),
                    Settings.PAC.GESTURE_ANYWHERE_TRIGGER_HEIGHT, bottom);
            return true;
        }
        return false;
    }
    ...
    private void updatePositionSummary(int value) {
        ...
        Settings.PAC.putInt(getContentResolver(),
                Settings.PAC.GESTURE_ANYWHERE_POSITION, value);
    }
    ...
    public void onPause() {
        super.onPause();
        Settings.PAC.putInt(getContentResolver(),
                Settings.PAC.GESTURE_ANYWHERE_SHOW_TRIGGER, 0);
    }
    ...
    public void onResume() {
        super.onResume();
        Settings.PAC.putInt(getContentResolver(),
                Settings.PAC.GESTURE_ANYWHERE_SHOW_TRIGGER, 1);
    }
}
