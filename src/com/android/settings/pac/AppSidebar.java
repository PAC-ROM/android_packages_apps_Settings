...
public class AppSidebar extends SettingsPreferenceFragment implements
    ...
    private PacSeekBarPreference mTransparencyPref;
    private ListPreference mPositionPref;
    private CheckBoxPreference mHideLabelsPref;
    private PacSeekBarPreference mTriggerWidthPref;
    private PacSeekBarPreference mTriggerTopPref;
    private PacSeekBarPreference mTriggerBottomPref;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEnabledPref.setChecked((Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.APP_SIDEBAR_ENABLED, 0) == 1));
        mEnabledPref.setOnPreferenceChangeListener(this);

        mHideLabelsPref = (CheckBoxPreference) findPreference(KEY_HIDE_LABELS);
        mHideLabelsPref.setChecked((Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.APP_SIDEBAR_DISABLE_LABELS, 0) == 1));

        PreferenceScreen prefSet = getPreferenceScreen();
        mPositionPref = (ListPreference) prefSet.findPreference(KEY_POSITION);
        mPositionPref.setOnPreferenceChangeListener(this);
        int position = Settings.PAC.getInt(getContentResolver(), Settings.PAC.APP_SIDEBAR_POSITION, 0);
        mPositionPref.setValue(String.valueOf(position));
        updatePositionSummary(position);

        mTransparencyPref = (PacSeekBarPreference) findPreference(KEY_TRANSPARENCY);
        mTransparencyPref.setValue(Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.APP_SIDEBAR_TRANSPARENCY, 0));
        ...
        mTriggerWidthPref.setValue(Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.APP_SIDEBAR_TRIGGER_WIDTH, 20));
        mTriggerWidthPref.setOnPreferenceChangeListener(this);

        mTriggerTopPref = (PacSeekBarPreference) findPreference(KEY_TRIGGER_TOP);
        mTriggerTopPref.setValue(Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.APP_SIDEBAR_TRIGGER_TOP, 0));
        mTriggerTopPref.setOnPreferenceChangeListener(this);

        mTriggerBottomPref = (PacSeekBarPreference) findPreference(KEY_TRIGGER_BOTTOM);
        mTriggerBottomPref.setValue(Settings.PAC.getInt(getContentResolver(),
                Settings.PAC.APP_SIDEBAR_TRIGGER_HEIGHT, 100));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mTransparencyPref) {
            ...
            Settings.PAC.putInt(getContentResolver(),
                    Settings.PAC.APP_SIDEBAR_TRANSPARENCY, transparency);
            return true;
        } else if (preference == mTriggerWidthPref) {
            int width = ((Integer)newValue).intValue();
            Settings.PAC.putInt(getContentResolver(),
                    Settings.PAC.APP_SIDEBAR_TRIGGER_WIDTH, width);
            return true;
        } else if (preference == mTriggerTopPref) {
            int top = ((Integer)newValue).intValue();
            Settings.PAC.putInt(getContentResolver(),
                    Settings.PAC.APP_SIDEBAR_TRIGGER_TOP, top);
            return true;
        } else if (preference == mTriggerBottomPref) {
            int bottom = ((Integer)newValue).intValue();
            Settings.PAC.putInt(getContentResolver(),
                    Settings.PAC.APP_SIDEBAR_TRIGGER_HEIGHT, bottom);
            return true;
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mHideLabelsPref) {
            ...
            Settings.PAC.putInt(getContentResolver(),
                    Settings.PAC.APP_SIDEBAR_DISABLE_LABELS,
                    value ? 1 : 0);
        } else {
    ...
    public boolean onPreferenceClick(Preference preference) {
        if(preference.getKey().equals(KEY_SETUP_ITEMS)) {
            ...
            intent.setComponent(new ComponentName("com.android.systemui",
                    "com.android.systemui.pac.sidebar.SidebarConfigurationActivity"));
    ...
    private void updatePositionSummary(int value) {
        ...
        Settings.PAC.putInt(getContentResolver(),
                Settings.PAC.APP_SIDEBAR_POSITION, value);
    }
    ...
    public void onPause() {
        super.onPause();
        Settings.PAC.putInt(getContentResolver(),
                Settings.PAC.APP_SIDEBAR_SHOW_TRIGGER, 0);
    }
    ...
    public void onResume() {
        ...
        Settings.PAC.putInt(getContentResolver(),
                Settings.PAC.APP_SIDEBAR_SHOW_TRIGGER, 1);
    }
}
