...
public class NetworkTraffic extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNetTrafficAutohideThreshold =
            (PacSeekBarPreference) prefSet.findPreference(NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD);
        int netTrafficAutohideThreshold = Settings.PAC.getInt(getContentResolver(),
        ...
        if (TrafficStats.getTotalTxBytes() != TrafficStats.UNSUPPORTED &&
            ...
            mNetTrafficVal = Settings.PAC.getInt(getContentResolver(),
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mNetTrafficState) {
            ...
            Settings.PAC.putInt(getActivity().getContentResolver(),
                    Settings.PAC.NETWORK_TRAFFIC_STATE, mNetTrafficVal);
            ...
            Settings.PAC.putInt(getContentResolver(),
                    Settings.PAC.NETWORK_TRAFFIC_COLOR, intHex);
            return true;
            ...
            Settings.PAC.putInt(getActivity().getContentResolver(),
                    Settings.PAC.NETWORK_TRAFFIC_AUTOHIDE, value ? 1 : 0);
            return true;
        } else if (preference == mNetTrafficAutohideThreshold) {
            int threshold = (Integer) newValue;
            Settings.PAC.putInt(getActivity().getContentResolver(),
                    Settings.PAC.NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD, threshold * 1);
            return true;
        }
        return false;
    }
