package com.android.settings.pac.util.aokp;
 ...
 * supported: "pac", and "system". Defaults to "pac" if none is specified. Note that there is no namespace on this attribute.
 * </ul>
 * <p/>
...
public class BaseSetting extends LinearLayout {
    ...
    /**
     * @return the table which the setting will be saved to. Currently only 'pac' and 'system' are supported
     */
