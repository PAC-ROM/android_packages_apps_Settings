...
public class BatteryBar extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBatteryBar.setValue((Settings.PAC.getInt(resolver,
                        Settings.PAC.STATUSBAR_BATTERY_BAR, 0)) + "");

        mBatteryBarStyle = (ListPreference) findPreference(PREF_BATT_BAR_STYLE);
        mBatteryBarStyle.setOnPreferenceChangeListener(this);
        mBatteryBarStyle.setValue((Settings.PAC.getInt(resolver,
        ...
        mBatteryBarChargingAnimation.setChecked(Settings.PAC.getInt(resolver,
                Settings.PAC.STATUSBAR_BATTERY_BAR_ANIMATE, 0) == 1);

        mBatteryBarThickness = (ListPreference) findPreference(PREF_BATT_BAR_WIDTH);
        mBatteryBarThickness.setOnPreferenceChangeListener(this);
        mBatteryBarThickness.setValue((Settings.PAC.getInt(resolver,
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mBatteryBarColor) {
            ...
            return Settings.PAC.putInt(resolver,
                    Settings.PAC.STATUSBAR_BATTERY_BAR, val);
        } else if (preference == mBatteryBarStyle) {
            int val = Integer.parseInt((String) newValue);
            return Settings.PAC.putInt(resolver,
                    Settings.PAC.STATUSBAR_BATTERY_BAR_STYLE, val);
        } else if (preference == mBatteryBarThickness) {
            int val = Integer.parseInt((String) newValue);
            return Settings.PAC.putInt(resolver,
                    Settings.PAC.STATUSBAR_BATTERY_BAR_THICKNESS, val);
        }
        return false;
    }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mBatteryBarChargingAnimation) {
            Settings.PAC.putInt(resolver,
                    Settings.PAC.STATUSBAR_BATTERY_BAR_ANIMATE,
