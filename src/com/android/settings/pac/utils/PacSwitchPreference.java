...
public class PacSwitchPreference extends SwitchPreference {
    public PacSwitchPreference(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public PacSwitchPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PacSwitchPreference(Context context) {
        super(context, null);
    }
