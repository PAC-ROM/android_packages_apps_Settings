...
public class PacSwitchBar implements SwitchBar.OnSwitchChangeListener  {
    ...
    public PacSwitchBar(Context context, SwitchBar switchBar, String key,
    ...
    private void setSwitchState() {
        boolean enabled = Settings.PAC.getInt(mContext.getContentResolver(),
