...
public class ScreenRecorderSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        String size = Settings.PAC.getString(resolver,
        ...
        String rate= Settings.PAC.getString(resolver,
        ...
        mRecordAudioPref.setChecked(Settings.PAC.getInt(resolver,
    ...
    public boolean onPreferenceChange(Preference preference, Object o) {
        if (preference == mVideoSizePref) {
            ...
            Settings.PAC.putInt(getActivity().getContentResolver(),
                    Settings.PAC.SCREEN_RECORDER_RECORD_AUDIO,
