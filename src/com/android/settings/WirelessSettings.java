...
public class WirelessSettings extends RestrictedSettingsFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mNfcPollingMode.setValue((Settings.PAC.getInt(activity.getContentResolver(),
                Settings.PAC.NFC_POLLING_MODE, 3)) + "");
        updateNfcPolling();
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mSmsApplicationPreference && newValue != null) {
            ...
            Settings.PAC.putInt(getActivity().getContentResolver(),
                    Settings.PAC.NFC_POLLING_MODE, newVal);
            updateNfcPolling();
            return true;
        }
        return false;
