...
import com.android.settings.pac.NavRingTargets;
import com.android.settings.pac.NavRingTargets.DialogConstant;
...
public class LockscreenRibbonItems extends Fragment implements ShortcutPickerHelper.OnPickListener,
    ...
    String[] SETTINGS_SYSTEM = Settings.System.AOKP_LOCKSCREEN_RIBBON;
    ...
    private void saveRibbons(ArrayList<RibbonItem> ribbonItems) {
        ...
        Settings.System.putArrayList(mContext.getContentResolver(),
                SETTINGS_SYSTEM[AokpRibbonHelper.HORIZONTAL_RIBBON_ITEMS], saveList);
        updateRibbonList();
        mAdapter.notifyDataSetChanged();
    }
    ...
    private ArrayList<RibbonItem> getRibbons() {
        ...
        ArrayList<String> joinedList = Settings.System.getArrayList(mContext.getContentResolver(),
                SETTINGS_SYSTEM[AokpRibbonHelper.HORIZONTAL_RIBBON_ITEMS]);
