...
import com.android.settings.ColorPickerSetting;
...
public class RibbonSettings extends Fragment implements OnSeekBarChangeListener, OnColorChangedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedinstanceState) {
        ...
        mEnable.setKey(SETTINGS_SYSTEM[AokpRibbonHelper.ENABLE_RIBBON]);
        mEnable.setChecked(Settings.System.getBoolean(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.ENABLE_RIBBON], false));


        mLongSwipe = (SingleChoiceSetting) main.findViewById(R.id.ribbon_long_swipe);
        mLongSwipe.setKey(SETTINGS_SYSTEM[AokpRibbonHelper.LONG_SWIPE]);
        ...
        mLongPress.setKey(SETTINGS_SYSTEM[AokpRibbonHelper.LONG_PRESS]);
        ...
        mSwipeVibrate.setKey(SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_VIBRATE]);
        mSwipeVibrate.setChecked(Settings.System.getBoolean(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_VIBRATE], false));

        mHandleLocation = (SingleChoiceSetting) main.findViewById(R.id.ribbon_swipe_location);
        mHandleLocation.setKey(SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_LOCATION]);
        ...
        mIconGravity.setKey(SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_ICON_GRAVITY]);
        ...
        mAnimationType.setKey(SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_ANIMATION_TYPE]);
        ...
        mAutoTimeout.setKey(SETTINGS_SYSTEM[AokpRibbonHelper.AUTO_HIDE_DURATION]);
        ...
        mHandleColor.setImageBitmap(getPreviewBitmap(Settings.System.getInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_COLOR], Color.TRANSPARENT)));
        mHandleColor.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                mColorCounter = 0;
                ColorPickerDialog picker = new ColorPickerDialog(mContext, Settings.System.getInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_COLOR], Color.TRANSPARENT));
        ...
        mRibbonColor.setImageBitmap(getPreviewBitmap(Settings.System.getInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_COLOR], Color.BLACK)));
        mRibbonColor.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                mColorCounter = 1;
                ColorPickerDialog picker = new ColorPickerDialog(mContext, Settings.System.getInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_COLOR], Color.BLACK));
                picker.setAlphaSliderVisible(true);
                picker.setOnColorChangedListener(RibbonSettings.this);
                picker.show();
            }
        ...
        mHandleWidth.setProgress(Settings.System.getInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_WEIGHT], 30));
        mHandleWidth.setOnSeekBarChangeListener(this);

        mHandleHeight = (SeekBar) main.findViewById(R.id.drag_handle_height);
        mHandleHeight.setProgress(Settings.System.getInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_HEIGHT], 50));
        mHandleHeight.setOnSeekBarChangeListener(this);

        mAnimationDuration = (SeekBar) main.findViewById(R.id.animation_duration);
        mAnimationDuration.setProgress(Settings.System.getInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_ANIMATION_DURATION], 50));
        mAnimationDuration.setOnSeekBarChangeListener(this);

        mRibbonSize = (SeekBar) main.findViewById(R.id.ribbon_size);
        mRibbonSize.setProgress(Settings.System.getInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_SIZE], 30));
        mRibbonSize.setOnSeekBarChangeListener(this);

        mRibbonSpace = (SeekBar) main.findViewById(R.id.ribbon_space);
        mRibbonSpace.setProgress(Settings.System.getInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_MARGIN], 5));
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        if (seekBar == mHandleWidth) {
            Settings.System.putInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_WEIGHT], mSeekBarProgress);
        } else if (seekBar == mHandleHeight) {
            Settings.System.putInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_HEIGHT], mSeekBarProgress);
        } else if (seekBar == mAnimationDuration) {
            Settings.System.putInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_ANIMATION_DURATION], mSeekBarProgress);
        } else if (seekBar == mRibbonSpace) {
            Settings.System.putInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_MARGIN], mSeekBarProgress);
        } else if (seekBar == mRibbonSize) {
            Settings.System.putInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_SIZE], mSeekBarProgress);
        }
    }
    ...
    public void onColorChanged(int color) {
        switch(mColorCounter) {
            case 0:
                ...
                Settings.System.putInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.HANDLE_COLOR], color);
                break;
            case 1:
                mRibbonColor.setImageBitmap(getPreviewBitmap(color));
                Settings.System.putInt(mContext.getContentResolver(), SETTINGS_SYSTEM[AokpRibbonHelper.RIBBON_COLOR], color);
